...
export default function AboutSection() {
  return (
    <section id="about" className="py-24 relative overflow-hidden bg-background transition-colors duration-500">
      <div className="container-custom relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-full max-w-6xl flex items-center justify-center">
          ...
          <div className="text-center max-w-5xl px-4 animate-scaleIn">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium leading-tight tracking-tight text-foreground mb-2">
              focus is on blending clear strategy,
            </h2>
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium leading-tight tracking-tight text-foreground mb-2">
              thoughtful design, and user
            </h2>
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium leading-tight tracking-tight text-foreground/50 mb-2">
              empathy to <span className="text-foreground/30">craft experiences</span>
            </h2>
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium leading-tight tracking-tight text-foreground/20">
