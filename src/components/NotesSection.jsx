    ...
    return (
        ...
        >
            <div className="flex items-center gap-4 mb-6">
                <span className="px-3 py-1 bg-lime-100 dark:bg-lime-900/20 text-lime-700 dark:text-lime-400 text-[10px] font-bold uppercase tracking-widest rounded-full border border-lime-200 dark:border-lime-500/20">
                    {category}
                </span>
            </div>

            <h3 className="text-2xl font-bold text-foreground mb-4 group-hover:text-lime-600 dark:group-hover:text-lime-400 transition-colors line-clamp-2">
                {title}
            </h3>
                ...
                <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-20">
                    <div className="max-w-2xl">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-lime-600 dark:text-lime-400 font-bold text-xs uppercase tracking-widest">Insights & Thoughts</span>
                        </div>
                    ...
                    <a href="#" className="flex items-center gap-3 text-sm font-bold text-foreground/80 hover:text-lime-500 transition-colors uppercase tracking-widest group">
                        View all stories
