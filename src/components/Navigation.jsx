    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${scrolled ? 'py-4' : 'py-6'}`}>
            <div className="container-custom">
                <div className={`relative flex items-center justify-between px-6 py-3 rounded-full transition-all duration-300 ${scrolled ? 'bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl' : ''}`}>

                    {/* Logo / Name */}
                    <a href="/" className="text-xl md:text-2xl font-serif italic text-white hover:text-lime-400 transition-smooth group flex items-center gap-1">
                    ...
                    <div className="hidden md:flex items-center gap-10">
                        <a href="#work" className="text-sm font-medium text-gray-300 hover:text-lime-400 transition-smooth">
                            Work
                        </a>
                        <a href="#about" className="text-sm font-medium text-gray-300 hover:text-lime-400 transition-smooth">
                            About
                        </a>
                        <a href="#process" className="text-sm font-medium text-gray-300 hover:text-lime-400 transition-smooth">
                            Process
                        </a>

                        {/* Get In Touch Button */}
                        <a href="#contact" className="px-6 py-2.5 bg-white text-black rounded-full text-sm font-semibold hover:bg-lime-400 transition-all hover:scale-105 active:scale-95 shadow-lg">
                            Get In Touch
                        </a>
                    </div>
